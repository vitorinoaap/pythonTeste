"""Pra galera que disse que precisar assistir a aula de fatiamento de novo e talz, minha dica é: faça um programa com
todas as funcionalidades daquela aula. Durante o curso, sempre que eu precisava de uma funcionalidade,
mas havia esquecido de como fazer, eu ia nesse programa e checava. Fazendo isso várias vezes consegui decorar várias
funcionalidades. Como aquela aula tem muita coisa não tem como vc aprender tudo de uma vez, sempre vai precisar dar
uma olhada. Vou deixar o código do programa aqui embaixo, mas tem coisa que fiz na maluquice, então foi mal kkk"""
